...
class Home extends React.PureComponent{
    ...
    ready =async () => {
       ...
       this.omegle.on('add_icecandidate',candidates=>{
            candidates.map(d=>{
       ...
       this.omegle.on('rtcpeerdescription',async(data,candidates)=>{
        ...
        try{
            ...
            localPC.onicecandidate = e => {
                if (!e.candidate) {
                  ...
                  setTimeout(()=>{
                    this.omegle.send_ice_candidates(this.ice_candidates).catch(e=>{
                        console.log(e);
                    })
                  },300);
                ...
                this.ice_candidates.push(e.candidate);
